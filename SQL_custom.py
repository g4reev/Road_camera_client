...
for d in devices:
    ...
    if connection_d:
        print(f"Remote database is coonect")
        query_avd_speed = (
        ...
        print(f"Камера {type_d}, ip: {host_ip_d}, по адресу: {d[6]}, недоступна для подключения")
    

for s in structure:
    print(s)

# (19, '10.133.10.157', 'krechet', '1306069', '55.9114', '54.7699', ' г. Уфа, ул. Проспект Дружбы народов из города', 'root', 'root', 'http://10.133.10.157:6400', '')